...
console.log(createMenuItem("gyro", 8, "greek"));
console.log(createMenuItem("naan, rice, masala", 10, "indian"));
console.log(createMenuItem("tofu pho", 12, "vietmanese"));
...
reviews.push({ name: "Mark", rating: 5, feedback: "Well, I've never been there, but I am sure I would love it...maybe" });
reviews.push({ name: "Jeff", rating: 4, feedback: "Well, I've had worse" });
...
function getReviewByIndex(arr, i) {
  let result = `${arr[i].name} gave the restaurant a ${arr[i].rating} star review, and their feedback was: ${arr[i].feedback}`;
  return result;
}
